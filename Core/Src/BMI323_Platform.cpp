...
void BMP_CS_Select(BMIobjPtr* intf_ptr) {
...
void BMP_CS_Deselect(BMIobjPtr* intf_ptr) {
...
int8_t BMI323_SPI_Read(uint8_t reg, uint8_t* data, uint32_t len, void *ptr)
{
...
int8_t BMI323_SPI_Write(uint8_t reg, const uint8_t* data, uint32_t len, void *ptr) {
    auto *intf_ptr = static_cast<BMIobjPtr*>(ptr);
