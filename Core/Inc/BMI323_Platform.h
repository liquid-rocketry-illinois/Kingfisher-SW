...
int8_t BMI3_SPI_Read(uint8_t reg, uint8_t* data, uint32_t len, void *intf_ptr);
int8_t BMI3_SPI_Write(uint8_t reg, const uint8_t* data, uint32_t len, void *intf_ptr);
