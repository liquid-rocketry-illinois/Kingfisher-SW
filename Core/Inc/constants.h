...
#define FINAL_DESCENT_VEL_MS    (-9.0f) // > -9 m/s = stable under main chute *BRIAN: this happens before main technically
...
#define TARE_ACC_DELTA_G        0.2f    // max inter-sample acceleration change (g) to count as stable
#define TARE_GYRO_DELTA_DPS     7.0f    // max inter-sample gyro change (deg/s) to count as stable
